...
abstract class Strings {
  ...
  /// No description provided for @todo_edit_title.
  ///
  /// In en, this message translates to:
  /// **'New To-do'**
  String get todo_edit_title;

  /// No description provided for @todo_list_title.
  ///
  /// In en, this message translates to:
  /// **'To-do list'**
  ...
  /// No description provided for @todo_description.
  ///
  /// In en, this message translates to:
  /// **'Description'**
  String get todo_description;

  /// No description provided for @todo_search.
  ///
  /// In en, this message translates to:
  /// **'Search...'**
